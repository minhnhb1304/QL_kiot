...
-- Dữ liệu giả lập giống production trước khi migrate
INSERT INTO transactions (type, category_id, category_name, amount, payment_source, note, transaction_date, created_at) VALUES
('IN',  1, 'Doanh thu nước ép',            350000, 'CASH', 'Bán tại quán',          '2026-08-01', '2026-08-01 09:15:00'),
('IN',  2, 'Doanh thu ship app',           120000, 'BANK', 'GrabFood',              '2026-08-01', '2026-08-01 12:30:00'),
('OUT', 4, 'Trái cây / Hoa quả',           200000, 'CASH', 'Mua cam',               '2026-08-02', '2026-08-02 07:00:00'),
('OUT', 6, 'Đá lạnh',                       20000, 'CASH', NULL,                    '2026-08-02', '2026-08-02 07:05:00'),
('IN',  1, 'Doanh thu nước ép',             35000, 'BANK', '[SMS SACOMBANK] +35,000VND', '2026-08-03', '2026-08-03 15:42:00');
